    ...
    return (
        <div
            className={cnNotificationItem({
                blue: type === TYPE_NOTIFICATION.LINK,
            })}
        >
            <div
                className={cnNotificationItem("circle", { visible: status })}
            ></div>
            {type === TYPE_NOTIFICATION.NOTICE && (
                <div className={cnNotificationItem("icon")}>
                    <ReactSVG src={statusUp} />
                </div>
            )}
            <div className={cnNotificationItem("col")}>
                <div
                    className={cnNotificationItem("title", {
                        white: type === TYPE_NOTIFICATION.LINK,
                    })}
                >
                    {title}
                </div>
                <div
                    className={cnNotificationItem("description", {
                        white: type === TYPE_NOTIFICATION.LINK,
                    })}
                >
                    {description}
                ...
                {type === TYPE_NOTIFICATION.LINK && (
                    <div
                        className={cnNotificationItem("link")}
                    ...
                    >
                        ...
                        <ReactSVG
                            src={arrowIcon}
                            wrapper="span"
                            className={cnNotificationItem("link-icon")}
                        />
                    </div>
                )}
            </div>
