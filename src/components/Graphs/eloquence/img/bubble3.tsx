    ...
    return (
        <>
            <svg width="154" height="185" viewBox="0 0 154 185" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="116.965" cy="46.3401" r="32.9875" transform="rotate(-119.206 116.965 46.3401)" fill={colors} fill-opacity="0.6"/>
                <circle cx="20.4399" cy="109.507" r="20.3" transform="rotate(-119.206 20.4399 109.507)" fill={colors}/>
                <circle cx="58.8597" cy="151.276" r="32.9875" transform="rotate(-119.206 58.8597 151.276)" fill={colors} fill-opacity="0.6"/>
