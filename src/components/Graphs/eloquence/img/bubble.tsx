    ...
    return (
        < >
            <svg width="171" height="182" viewBox="0 0 171 182" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="137.613" cy="128.687" r="32.9875" fill={colors} fill-opacity="0.6"/>
                <circle cx="56.05" cy="44.225" r="20.3" fill={colors} fill-opacity="0.6"/>
                <rect x="14" y="29" width="145" height="145" rx="72.5" fill={colors}/>
                <circle cx="33.2121" cy="66.3376" r="32.9875" fill={colors} fill-opacity="0.6"/>
            </svg>
        </>
    );
}
