    ...
    return (
        <>
            <svg width="183" height="184" viewBox="0 0 183 184" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="33.4014" cy="101.695" r="32.9875" transform="rotate(86.9403 33.4014 101.695)" fill={colors} fill-opacity="0.6"/>
                ...
                <circle cx="131.802" cy="33.1012" r="32.9875" transform="rotate(86.9403 131.802 33.1012)" fill={colors} fill-opacity="0.6"/>
