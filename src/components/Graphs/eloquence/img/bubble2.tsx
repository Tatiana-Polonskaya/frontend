    ...
    return (
        <>
            <svg width="168" height="184" viewBox="0 0 168 184" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ellipse cx="48.2841" cy="33.9075" rx="32.9875" ry="32.9875" transform="rotate(-30.9751 48.2841 33.9075)" fill={colors} fill-opacity="0.6"/>
                ...
                <ellipse cx="142.219" cy="75.7655" rx="19.211" ry="19.211" transform="rotate(-30.9751 142.219 75.7655)" fill={colors} fill-opacity="0.6"/>
            </svg>
